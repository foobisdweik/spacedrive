...
const CONTENT_KIND_CONFIG: Record<
	string,
...
> = {
	...
	spreadsheet: {iconName: 'Spreadsheet', color: '#10B981'},
	presentation: {iconName: 'Presentation', color: '#F97316'},
	email: {iconName: 'Email', color: '#3B82F6'},
	calendar: {iconName: 'Calendar', color: '#06B6D4'},
	contact: {iconName: 'Contact', color: '#EC4899'},
	...
	unknown: {iconName: 'Unknown', color: '#6B7280'}
};;
					...
					{stats.map((stat) => {
						...
						return (
							<button
								...
								className="hover:bg-app-box/50 group flex aspect-square flex-col items-center justify-center rounded-lg p-4 transition-colors"
							>
								<img
									src={icon}
									alt={stat.name}
								...
								<div className="w-full text-center">
									<div className="text-ink mb-1 text-sm font-medium capitalize">
										{stat.name}
									</div>
